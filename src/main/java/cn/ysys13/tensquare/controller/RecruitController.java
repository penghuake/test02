...
import cn.ysys13.tensquare.service.RecruitService;
...
public class RecruitController {
	...
	public Result recommend(){
		return new Result(true,StatusCode.OK,"查询推荐职位成功",
	...
	public Result newlist(){
		return new Result(true,StatusCode.OK,"查询推荐职位成功",
				recruitService.findTop12ByStateNotOrderByCreatetimeDesc("0"));
	}
