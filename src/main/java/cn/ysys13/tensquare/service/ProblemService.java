...
import cn.ysys13.tensquare.dao.ProblemDao;
...
public class ProblemService {
	 ...
	 * @return
	 */
	public Page<Problem> findNewListByLabelId(String labelId,Integer page,Integer size){
    ...
    public Page<Problem> hotlist(String label, Integer page, Integer size) {
		Pageable pageable=PageRequest.of(page-1,size);
		return problemDao.findHotlistByLabelId(label,pageable);
    }

	public Page<Problem> waitlist(String label, Integer page, Integer size) {
		Pageable pageable=PageRequest.of(page-1,size);
		return problemDao.findWaitlistByLabelId(label,pageable);
	}
}
